...
var signApp = function() {
    ...
    childProcess.exec('codesign --deep --force --sign "3rd Party Mac Developer Application: Shanghai HotLong Software Co. Ltd. (G6293UGCRM)" "' + finalAppDir.cwd() + '"', function (error, stdout, stderr) {
        if (error || stderr) {
